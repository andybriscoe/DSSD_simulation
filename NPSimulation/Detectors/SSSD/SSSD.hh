...
namespace SSSD_LOCAL{
   ...
   const G4double ResoEnergy  = 0.003  ;// = 150keV of Resolution   //   Unit is MeV/2.35
   //const G4double ResoEnergy  = 0.043  ;// = 150keV of Resolution   //   Unit is MeV/2.35
   const G4double EnergyThreshold = 0.01*keV;
   // Geometry
   const G4double DetectorSize      = 0.68*mm           ;
   const G4double SiliconThickness  = 10*micrometer ;
   const G4double FrameThickness    = 0.67*mm            ;
   const G4double SiliconSize       = 0.67*mm           ;
   const G4double AluThickness      = 0.01*micrometer  ;
   const G4int  NumberOfStrip       = 1            ;
